...
HOST_CODE void Configuration::loadFromFile(const std::string& filePath)
{
...
HOST_CODE bool Configuration::hasProperty(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
	return properties.find(propertyName) != properties.end();
}

HOST_CODE const std::string& Configuration::getProperty(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
...
HOST_CODE unsigned char Configuration::getPropertyAsUnsignedChar(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
	return (unsigned char)atoi(getProperty(properties, propertyName).c_str());
}

HOST_CODE unsigned int Configuration::getPropertyAsUnsignedInt(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
	return (unsigned int)atoi(getProperty(properties, propertyName).c_str());
}

HOST_CODE long Configuration::getPropertyAsInt(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
	return atoi(getProperty(properties, propertyName).c_str());
}

HOST_CODE float Configuration::getPropertyAsFloat(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
	return (float)atof(getProperty(properties, propertyName).c_str());
}

HOST_CODE bool Configuration::getPropertyAsBool(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
	return getProperty(properties, propertyName) == "true";
}

HOST_CODE vml_vec4 Configuration::getPropertyAsVec4(const std::map<std::string, std::string>& properties, const std::string& propertyName)
{
	return ParseUtils::parseVec4(getProperty(properties, propertyName));
}

HOST_CODE void Configuration::getPropertyAsVec2Array(const std::map<std::string, std::string>& properties, const std::string& propertyName, vml_vec2* vec2Array, unsigned int& size, unsigned int maxSize)
{
...
HOST_CODE void Configuration::copyProperty(const std::map<std::string, std::string>& properties, const std::string& propertyName, char* dstBuffer, unsigned int bufferSize)
{
	std::string value;
