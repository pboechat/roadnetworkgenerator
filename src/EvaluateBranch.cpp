...
//////////////////////////////////////////////////////////////////////////
DEVICE_CODE void EvaluateStreetBranch::execute(StreetBranch& branch, WorkQueuesSet* backQueues)
{
	// p6
	if (branch.delay < 0)
	{
...
//////////////////////////////////////////////////////////////////////////
DEVICE_CODE void EvaluateHighwayBranch::execute(HighwayBranch& branch, WorkQueuesSet* backQueues)
{
	// p6
	if (branch.delay < 0)
	{
